...
router = APIRouter(prefix="/institutes", tags=["institutes"], dependencies=[Depends(get_current_user)])
...
@router.delete("/{institute_id}", dependencies=[Depends(require_role("owner", "manager"))])
